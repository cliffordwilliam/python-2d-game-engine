...
class ThinFire:
    ...
    def __init__(
        ...
        self.aniamtion_data: dict = animation_data
        ...
        self.frame_data: dict[str, int] = self.aniamtion_data[self.initial_animation]["animation_sprites_list"][0]
    ...
    def _on_animation_frame_change(self, frame_data: dict[str, int]) -> None:
