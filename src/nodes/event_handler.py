...
class EventHandler:
    ...
    def bind_game_local_setting_key_with_input_flag_setter(self) -> None:
        ...
        self.key_down_handlers = {
            self.game.local_settings_metadata_instance.up: self.KEYDOWN_UP,
            self.game.local_settings_metadata_instance.down: self.KEYDOWN_DOWN,
            self.game.local_settings_metadata_instance.left: self.KEYDOWN_LEFT,
            self.game.local_settings_metadata_instance.right: self.KEYDOWN_RIGHT,
            self.game.local_settings_metadata_instance.enter: self.KEYDOWN_ENTER,
            self.game.local_settings_metadata_instance.pause: self.KEYDOWN_PAUSE,
            self.game.local_settings_metadata_instance.jump: self.KEYDOWN_JUMP,
            self.game.local_settings_metadata_instance.attack: self.KEYDOWN_ATTACK,
            # REMOVE IN BUILD
        ...
        self.key_up_handlers = {
            self.game.local_settings_metadata_instance.up: self.KEYUP_UP,
            self.game.local_settings_metadata_instance.down: self.KEYUP_DOWN,
            self.game.local_settings_metadata_instance.left: self.KEYUP_LEFT,
            self.game.local_settings_metadata_instance.right: self.KEYUP_RIGHT,
            self.game.local_settings_metadata_instance.enter: self.KEYUP_ENTER,
            self.game.local_settings_metadata_instance.pause: self.KEYUP_PAUSE,
            self.game.local_settings_metadata_instance.jump: self.KEYUP_JUMP,
            self.game.local_settings_metadata_instance.attack: self.KEYUP_ATTACK,
            # REMOVE IN BUILD
            pg.K_0: self.KEYUP_0,
            pg.K_9: self.KEYUP_9,
        }
        ...
        self.mouse_down_handlers = {
            self.game.local_settings_metadata_instance.lmb: self.MOUSEDOWN_LMB,
            self.game.local_settings_metadata_instance.mmb: self.MOUSEDOWN_MMB,
            self.game.local_settings_metadata_instance.rmb: self.MOUSEDOWN_RMB,
        }

        # REMOVE IN BUILD
        self.mouse_up_handlers = {
            self.game.local_settings_metadata_instance.lmb: self.MOUSEUP_LMB,
            self.game.local_settings_metadata_instance.mmb: self.MOUSEUP_MMB,
            self.game.local_settings_metadata_instance.rmb: self.MOUSEUP_RMB,
        }
