...
class OptionsMenu:
    ...
    def __init__(self, game: "Game"):
        ...
        self.resolution_text: str = self.resolution_texts[self.resolution_index]
        ...
        self.decoration_vetical_height: int = self.button_container.buttons_len * (
    ...
    def set_resolution_index(self, value: int) -> None:
        ...
        self.resolution_index = self.resolution_index % self.resolution_texts_len
        ...
        self.game.debug_draw.add(
            {
                ...
                "y": 6,
                "text": (
                    f"options menu state " f"state: {self.state_names[self.state]}"
                ),
            }
        )
