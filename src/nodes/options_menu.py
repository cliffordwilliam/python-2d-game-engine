...
class OptionsMenu:
    ...
    def __init__(self, game: "Game"):
        ...
        self.surf: pg.Surface = pg.Surface(
            (NATIVE_RECT.width, NATIVE_RECT.height)
        )
        self.surf.fill(self.native_clear_color)
        ...
        self.game.debug_draw.add(
            {
                ...
                "x": 0,
                "y": 5,
                "text": f"options menu state: {self.state}",
            }
        )
